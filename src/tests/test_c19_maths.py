import pytest
from algo_project.c19_maths import spiral_matrix, reverse_32_bit_integer, gcd, maximum_collinear_points, compute_slope, josephus1, triangle_numbers #, josephus2, josephus3, triangle_numbers
...
def test_reverse_positive_integer():
    ...
    assert reverse_32_bit_integer(-15) == -51
    assert reverse_32_bit_integer(123456789) == 987654321
